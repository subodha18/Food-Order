...
const Footer = () => {
  return (
    <div className="flex flex-col w-full text-white items-center justify-center py-5 bg-[#02060c]">
        <p className="mt-3 justify-between">Made with ❤️ by <a href="https://www.linkedin.com/in/subodha-kumar-sahoo/">Subodha </a></p>
        <div className="my-3 flex items-center justify-center">
          <a
            className="ml-3 text-4xl transition-all hover:text-linkedIn"
            href="https://www.linkedin.com/in/subodha-kumar-sahoo/"
            target="_blank"
            title="Subodha's Linkedin Profile"
          >
            <FontAwesomeIcon icon={faLinkedin}/>
          </a>
          <a
            className="ml-3 text-4xl transition-all hover:text-github"
            href="https://github.com/subodha18"
            target="_blank"
          ...
          <a
            ...
            href="https://www.instagram.com/subodha_2005/?hl=en"
            target="_blank"
